...
//        public async Task<bool> LogIn(LogInSellerDto entity, CancellationToken cancellation,bool IsRememberMe)
//        {
...
//        {
//            _userManager.
//            _userManager.UpdateAsync(_userManager.FindByIdAsync(id));
//            if (seller != null)
//            {
...
//            {
//                _context.Users.Update(_mapper.Map<User>(sellerDto));
...
//        {
//            bool result = false;
//            User? seller = await _context.Users.Where(c => c.Id == id).FirstOrDefaultAsync(cancellationToken);
//            if (seller != null)
//            {
...
//        {
//            var result = await (_context.Users.Where(u=>u.Role==Role.Seller).ToListAsync(cancellationToken));
